...
| 카테고리 | 주요 내용 | 관련 문서 |
| :--- | :--- | :--- |
| **🏁 입문 (Get Started)** | 엔진 설치, 환경 설정 및 첫 번째 게임 루프 구동 방법 | [Tutorial](./tutorial/01-installation.md) / [Quick Start](../README.md#-%EB%B9%A0%EB%A5%B8-%EC%8B%9C%EC%9E%91-quick-start) |
| **💡 핵심 개념 (Concepts)** | 엔진의 설계 철학, 변수 시스템, 씬의 생명 주기 등 | [Architecture](./concepts/overview.md) / [Scenes](./concepts/scenes.md) / [Variables](./concepts/variables.md) |
